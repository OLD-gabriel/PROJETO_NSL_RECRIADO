<?php
    include "database.php";
        ...
        if($verificar_inexistencia->num_rows == 0 ){
            $inserir_dados = query("INSERT INTO eletivas(nome_eletiva,professor_1,professor_2,professor_3,curso,vagas,turno) VALUES ('$nome_eletiva','$professor_1','$professor_2','$professor_3','$curso','$vagas','$turno')");
